...
const CHALLENGE_SECTION = {
  title: 'Solving Ingredient Challenges, Together',
  description: 'Behind every great product is a dependable partner. We work hand-in-hand with manufacturers to stabilize sourcing, streamline logistics, and deliver quality that strengthens both your operations and customer trust.',
  items: [
    {
