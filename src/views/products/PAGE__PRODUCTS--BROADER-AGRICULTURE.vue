...
import { broaderAgriculture } from '@/data/index.js'  
</script>
...
<template>
            ...
            <ComponentGrid :columns="{ base: 1, md: 2 }" gap="xl" align="center">
                <div>
                    <h2
                        ...
                        {{ broaderAgriculture.productOverview.title }}
                    </h2>
                    <p class="font-body text-lg text-pickled-bluewood-700 leading-relaxed mb-6">
                        {{ broaderAgriculture.productOverview.description }}
                    </p>
                </div>
                <div class="bg-[hsl(var(--cello-100))] p-8 rounded-lg">
                    ...
                    <ul class="space-y-3">
                        <li v-for="feature in broaderAgriculture.productOverview.features" :key="feature.title"
        ...
        <ComponentContainer size="2xl" padding="responsive" :constrainWidth="true">
            <div class="text-center mb-12">
                <h2
                    ...
                    {{ broaderAgriculture.productCategories.title }}
                </h2>
                <p class="font-body text-lg text-pickled-bluewood-700 leading-relaxed max-w-4xl mx-auto">
                    {{ broaderAgriculture.productCategories.description }}
                </p>
            </div>
            <ComponentGrid :columns="{ base: 1, md: 2, lg: 4 }" gap="lg">
                <ComponentProductCard v-for="category in broaderAgriculture.productCategories.categories"
    ...
    <!-- CTA Section -->
    <ComponentCtaGetInTouch title="Partner With Us for Bulk Agriculture Supply"
        description="Secure certified, scalable, and cost-efficient supply of dehydrated vegetables, pulses, legumes, and peanuts with E-Sunrise Australia. Our expertise in global trade and logistics makes us a trusted partner for industrial and export buyers."
        buttonText="Request Bulk Quote" backgroundColor="pickled-bluewood-100" />
</template>
