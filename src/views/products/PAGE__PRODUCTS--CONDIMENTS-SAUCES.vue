...
import { condimentsSauces } from '@/data/index.js'  
</script>
            ...
            <ComponentGrid :columns="{ base: 1, md: 2 }" gap="xl" align="center">
                <div>
                    <h2
                        ...
                        {{ condimentsSauces.productOverview.title }}
                    </h2>
                    <p class="font-body text-lg text-pickled-bluewood-700 leading-relaxed mb-6">
                        {{ condimentsSauces.productOverview.description }}
                    </p>
                </div>
                <div class="bg-[hsl(var(--cello-100))] p-8 rounded-lg">
                    ...
                    <ul class="space-y-3">
                        <li v-for="feature in condimentsSauces.productOverview.features" :key="feature.title"
        ...
        <ComponentContainer size="2xl" padding="responsive" :constrainWidth="true">
            <div class="text-center mb-12">
                <h2
                    ...
                    {{ condimentsSauces.productCategories.title }}
                </h2>
                <p class="font-body text-lg text-pickled-bluewood-700 leading-relaxed max-w-4xl mx-auto">
                    {{ condimentsSauces.productCategories.description }}
                </p>
            </div>
            <ComponentGrid :columns="{ base: 1, md: 2, lg: 4 }" gap="lg">
                <ComponentProductCard v-for="category in condimentsSauces.productCategories.categories"
                    :key="category.title" :product="{
                        title: category.title,
                        image: category.image,
                        specs: category.specs
                    }" variant="detailed" imageFit="object-contain" />
            </ComponentGrid>
        </ComponentContainer>
    </ComponentSection>
