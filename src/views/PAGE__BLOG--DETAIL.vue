...
const {
    ...
    hasError: postError,
    errorDisplay: postErrorDisplay,
    loadPostBySlug
} = usePosts()

// Computed properties
const isLoading = computed(() => siteLoading.value || postLoading.value)
const hasError = computed(() => siteError.value || postError.value)
const errorDisplay = computed(() => siteErrorDisplay.value || postErrorDisplay.value)
