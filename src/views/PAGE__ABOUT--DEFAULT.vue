<script setup>
import { aboutPage } from '@/data/staticContent.js'
import ComponentHero from '@/components/COMPONENT__HERO--PAGE.vue'
</script>

<template>
  <section class="page-about">
    <ComponentHero :title="aboutPage.hero.title" :subtitle="aboutPage.hero.subtitle" :cta-text="aboutPage.hero.ctaText"
      :cta-link="aboutPage.hero.ctaLink" />
    <div class="page-about__content max-w-4xl mx-auto py-8 px-6">
      <div class="page-about__body">
        <div v-for="(block, index) in aboutPage.blocks" :key="index" class="page-about__block mb-6">
          <!-- Content Block -->
          <div v-if="block.type === 'content'" class="page-about__content-block">
